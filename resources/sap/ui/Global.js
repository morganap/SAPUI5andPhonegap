 ...
 */
if(window.OpenAjax&&window.OpenAjax.hub){OpenAjax.hub.registerLibrary("sap","http://www.sap.com/","0.1",{})}jQuery.sap.declare("sap.ui.Global");jQuery.sap.require("jquery.sap.dom");if(typeof window.sap!=="object"&&typeof window.sap!=="function"){window.sap={}}if(typeof window.sap.ui!=="object"){window.sap.ui={}}sap.ui=jQuery.extend(sap.ui,{version:"1.8.4",buildinfo:{lastchange:"198749",buildtime:"201211072311"}});
